...
class Profile_API{
    ...
    static func requestSignUp(delegate: AppDelegate, regemail: String,
                              nickname: String,
                              password pass: String, callback  : @escaping (_ msg_RequestSignUP: MessageModel) -> ()){
    ...
    //MARK:- Авторизация
    static func requestLogin(delegate: AppDelegate, email: String, password: String, callback  : @escaping (MessageModel) -> ()){
    ...
    static func requestProfileInfo(delegate: AppDelegate, email: String, callback: @escaping(UserInfoModel) -> ()){
    ...
    static func requestLogout(delegate: AppDelegate, callback: @escaping (MessageModel) -> ()){
    ...
    static func requestSetImageProfile(delegate: AppDelegate, data: Data, callback: @escaping (MessageModel) -> ()){
    ...
    static func requestGetUrlPhotoProfile(delegate: AppDelegate, email: String, callback: @escaping(MessageModel) -> ()){
    ...
    static func requsetChangeUserName(delegate: AppDelegate, nickname: String, pass: String, callback: @escaping(MessageModel) -> ()){
    ...
    static func requestChangePassword(delegate: AppDelegate, newPwd: String, oldPwd: String, callback: @escaping (MessageModel) -> ()){
    ...
    static func requestResorePassword(delegate: AppDelegate, email: String, callback: @escaping (MessageModel) -> ()){
    ...
    //MARK:- Search Users
    static func requestSearchUsers(delegate: AppDelegate, nickName: String, callback  : @escaping (String?, Int, [UsersModel]) -> () ){
    ...
    //MARK:- Request Famous
    static func requestFamous(delegate: AppDelegate, callback: @escaping (String?, Int, [UsersModel]) -> ()){
    ...
    static func requestFollowUp(delegate: AppDelegate, email: String, callback: @escaping (MessageModel) -> ()){
    ...
    static func requestGetOwners(delegate: AppDelegate, email: String, callback: @escaping (String?, Int, [Owners_Model]) -> ()){
        delegate.providerProfile.rx.request(.profileGetOwners(email: email)).asObservable().subscribe(onNext: { (responce) in
            if responce.statusCode >= 200 && responce.statusCode < 300{
                let dataResoponse = responce.data
                if let strData = String(data: dataResoponse, encoding: String.Encoding.utf8){
                    var uModel : [Owners_Model] = []
                    if let object = Mapper<Owners_Model>().mapArray(JSONString: strData){
                        uModel = object
                    }
                    if uModel.count == 0{
                        callback(nil, 100, uModel)
            ...
            callback(responce.description, responce.statusCode, [Owners_Model]())
        }, onError: { (error) in
            if let e = error as? MoyaError{
                callback(e.localizedDescription, 400, [Owners_Model]())
            }else{
                callback(error.localizedDescription, 400, [Owners_Model]())
            }
        }, onCompleted: {
    ...
    static func requestGetFollowers(delegate: AppDelegate, email: String, callback: @escaping (String?, Int, [Owners_Model]) -> ()){
    ...
    static func requestNewFollowers(delegate: AppDelegate, email: String, callback: @escaping (String?, Int, [Owners_Model]) -> ()){
    ...
    static func requestNewLikes(delegate: AppDelegate, email: String, callback: @escaping (String?, Int, [HistoryVideo]) -> ()){
    ...
    static func requestBalance(delegate: AppDelegate, callback: @escaping (Balance) -> ()){
    ...
    static func requestActuals(delegate: AppDelegate, email: String, callback: @escaping (String?, Int, [Owners_Model]) -> ()){
        delegate.providerProfile.rx.request(.profileGetFollowers(email: email)).asObservable().subscribe(onNext: { (responce) in
            if responce.statusCode >= 200 && responce.statusCode < 300{
                let dataResoponse = responce.data
                if let strData = String(data: dataResoponse, encoding: String.Encoding.utf8){
    ...
    static func requestSetUnFollow(delegate: AppDelegate, email: String, callback: @escaping (MessageModel)->()){
    ...
    //
    static func requsetNotificationStatus(delegate: AppDelegate, callback: @escaping (NotificationModel)->()) {
        delegate.providerProfile.rx.request(Profile_ServerAPI.profileNotify).mapObject(NotificationModel.self).asObservable().subscribe(onNext: { (model) in
            if model.code != nil{
                callback(model)
                return
            } else {
    ...
    static func requestCircles(delegate: AppDelegate, email: String, callback: @escaping (String?, Int, [Owners_Model]) -> ()){
    ...
    static func requsetPutCircle(delegate: AppDelegate, email: String, callback: @escaping(MessageModel) -> ()){
    ...
    static func requestDeleteCircle(delegate: AppDelegate, owner_email: String, displayed_email: String, callback:  @escaping(MessageModel) -> ()){
        delegate.providerProfile.rx.request(.profileDeleteCircle(owner_email: owner_email,displayed_email:displayed_email)).mapObject(MessageModel.self).asObservable().subscribe(onNext: { (responce) in
            if responce.code != nil{
                callback(responce)
                return
            } else {
    ...
    static func requsetAddWallet(delegate: AppDelegate,
                                 email: String,
                                 address: String,
                                 callback: @escaping(MessageModel) -> ()){
